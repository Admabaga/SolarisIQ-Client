import './HydroElectricalEnergy.css'
...
export default function HydroElectricalEnergy() {
                    ...
                    {activeTab === 'production' ? (
                        ...
                        <div className="profile-info-section">
                            <ProductionByRegion
                                ...
                                indicator={'Hydropower Generation'}
                                label={`Consumo energia hidro electrica por Región Teravatios/hora(TWh)`}
                            ...
                            <TopProducers
                                ...
                                indicator={'Hydropower Generation'}
                                label={`Top 10 Países - Consumo energia hidro electrica ${year}`}
                        ...
                        <div className="profile-info-section">
                            <ProductionByRegion
                                ...
                                indicator={'Hydropower Generation'}
                                label={`Producción energia hidro electrica por Región Teravatios/hora(TWh)`}
                            ...
                            <TopProducers
                                ...
                                indicator={'Hydropower Generation'}
                                label={`Top 10 Países - Producción energia hidro electrica ${year}`}
