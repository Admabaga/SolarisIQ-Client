...
export default function AboutUs() {
  ...
  return (
    <>
      ...
      {/* Contenido principal ahora sin el contenedor limitante */}
          ...
          <div className="container">
            <div className="ratio ratio-16x9 rounded-3 overflow-hidden shadow">
              <iframe 
                ...
                title="Cómo funciona Solaris IQ" 
                allowFullScreen
              ></iframe>
            </div>
          </div>
        ...
        <section className="team-section my-5 py-5 bg-light">
          <div className="container">
            ...
            <div className="row justify-content-center">
              {[
                {name: "Ana López", role: "CEO", img: "team4.jpg", quote: "La energía sostenible debe ser accesible"},
              ].map((member, i) => (
